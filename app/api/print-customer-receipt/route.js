...
export async function POST(request) {
  ...
  if (!printServerUrl) {
    console.error('[print-customer-receipt] PRINT_SERVER_URL is not set');
  ...
  try {
    const res = await fetch(`${printServerUrl}/print-customer-receipt`, {
      method: 'POST',
      headers,
    ...
    console.error('[POST /api/print-customer-receipt]', err.message);
