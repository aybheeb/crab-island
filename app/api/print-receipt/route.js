...
export async function POST(request) {
  ...
  if (!printServerUrl) {
    console.error('[print-receipt] PRINT_SERVER_URL is not set');
  ...
  try {
    const res = await fetch(`${printServerUrl}/print-receipt`, {
      method: 'POST',
      headers,
    ...
    console.error('[POST /api/print-receipt]', err.message);
